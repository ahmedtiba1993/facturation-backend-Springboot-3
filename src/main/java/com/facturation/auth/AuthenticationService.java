  ...
  public AuthenticationResponse register(RegisterRequest request) {
    ...
    if(!findUser.isEmpty()){
      List<String> errors = new ArrayList<>();
        errors.add("l'adresse email fourni existe déjà dans notre système. Veuillez choisir une adresse email uniques.");
      throw new InvalidEntityException("Impossible de créer un nouvel utilisateur", ErrorCodes.USER_EXISTE,errors);
    }
